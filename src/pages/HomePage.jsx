...
const HomePage = () => {
  ...
  const handleSaveEdit = async (e) => {
    ...
    try {
      const response = await fetch(`https://dev.codeleap.co.uk/careers/${editingPost.id}/`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleDeletePost = async () => {
    ...
    try {
      const response = await fetch(`https://dev.codeleap.co.uk/careers/${postToDelete.id}/`, {
        method: "DELETE",
      });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 to-pink-200 p-4">
      <div className="max-w-3xl mx-auto bg-white p-4 rounded-lg shadow-lg">
        ...
        <p className="text-gray-600">Share your thoughts, ideas and stories with our community</p><div className="h-1 w-32 bg-gradient-to-r from-indigo-500 to-pink-500 rounded-full mx-auto mt-4"></div>
        </header>
